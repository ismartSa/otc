	...
	<body>
		...
		<div class="container">
			<div id="home" class="header wow bounceInDown" data-wow-delay="0.4s">
					<div class="top-header">
                        ...
                        <ul class="top-nav" id="nav">
                                <li><a href="#about" class="scroll" style="  width: 211.6px;height: 61.6px;"> How it Works </a></li>
								...
								<li><a href="#about" class="scroll" style="  width: 210.6px;height: 61.6px;">SignUp<span class="caret"></span></a>
			...
			<div class="banner-info">
				<div class="container">
					<h1 class="wow fadeIn" data-wow-delay="0.5s"><span>ONLINE</span><br /><label>THERAPY CONSULTATION</label></h1>
				...
				<div class="container">
					<div class="col-md-3 wow bounceIn" data-wow-delay="0.4s">
						<div class="top-grid">
							...
							<h3><a href="#">Effective</a></h3>
							<label> </label>
							<p>Major studies show online therapy is just as effective as face-to-face therapy.*</p>
						</div>
					</div>
					<div class="col-md-3 wow bounceIn" data-wow-delay="0.4s">
						<div class="top-grid">
							...
							<label> </label>
							<p>No waiting rooms, traveling to an office or leaving work.</p>
						</div>
					</div>
					<div class="col-md-3 wow bounceIn" data-wow-delay="0.4s">
						<div class="top-grid">
							...
							<label> </label>
							<p>With no need to go to an office, you save on travel and childcare expenses and time.</p>
						</div>
					</div>
					<div class="col-md-3 wow bounceIn" data-wow-delay="0.4s">
						<div class="top-grid">
							...
							<label> </label>
							<p>Access a wide selection of in-state licensed and screened therapists and psychiatrists.</p>
						</div>
					</div>
					<div class="clearfix"> </div>
				</div>
			...
			<div id="about" class="about">
				<div class="head-section">
					<div class="container">
						<h3><span>How it </span><label>Works?</label></h3>
					</div>
				</div>
					<!--- about-grids ---->
					<div class="about-grids">
						<div class="col-md-4 about-grid about-grid1 wow fadeInLeft" data-wow-delay="0.4s">
							<div class="about-grid-info">
								<h4><a href="#">Find an Online therapist</a></h4>
								<p>Online Therapy Consultation has therapists in each state. Our Pyschiatrist team provide psychiatric assessments, evaluations and treatment. </p>
							</div>
						...
						<div class="col-md-4 about-grid about-grid2 wow fadeInUp" data-wow-delay="0.4s">
							...
							<div class="about-grid-info">
								<h4><a href="login.html">Book An Appointment</a></h4>
								<p> Therapist can maintain their scheduled meeting details and consultation details by maintaining a individual profile .  Click on the above sign in to login into your profile and book an appointment.</p>
							</div>
						</div>
						<div class="col-md-4 about-grid about-grid1 wow fadeInRight" data-wow-delay="0.4s">
							<div class="about-grid-info">
								<h4><a href="PatientLogIn.html"> Make an Online Session</a></h4>
								<p>Patients can maintain their Session details, evaluations and treatment by maintaining a individual profile. Click on the above sign in to login into your profile.</p>
							</div>
							<div class="about-grid-pic">
			...
			<div id="process" class="process">
				<div class="head-section">
					<div class="container">
						<h3><span>About </span><label>OTC </label></h3>
					</div>
				</div>
				<div class="container">
		...
		<!--	<div class="blog">
			...
			<!---- work-with-us---->
			<div id="contact-us"class="work-with-us text-center">
				<div class="container">
					<h4>YOU ALSO WANT? WORK WITH US!</h4>
					<p>Send the application form for a free call and our manager will contact with you</p>
					<a class="catch-me wow shake" data-wow-delay="0.3s" href="ContactUs.php">contact us</a>
					<p><h4><span>OTC</span>Consulting Team</h4>
					<p><span class="map-icon1"> </span>119 N Salisbury VA 2760</p>
					<p><span class="map-icon2"> </span>info@otc.com</p>
					<p><span class="map-icon3"> </span>223-5555555</p></p>
				</div>
			</div>
			<!---- work-with-us---->
			<!--- portfolio ---->
