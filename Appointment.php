...
(`Date`,`Time`,`Duration`,`PatientId`,`ScheduleId`,`BillId`)
VALUES ( '$date','$time','$duration','$patientId','$sheduleId','$BillId')";
                            ...
                            <form method="POST" class="signup-form">
                                ...
                                <br />
                                 ...
                                 <div class="row" style="background-color: whitesmoke">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-5">
                                        ...
                                        <p>You have an appointment with Dr.John Glaser Scheduled on May 10 , 2017 at 10 am.</p>
                                        </div>
                                    </div>
                                        <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-12">
                                ...
                                <div class="row" style="background-color: whitesmoke">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-5">
                                        ...
                                        <input type="text" placeholder="Date" value="MM/DD/YYYY" style="width: 200px; background-color: white" name="date" />
                                        <label>Selected Time :</label>
                                        <input type="text" placeholder="Time" value="" style="width: 200px; background-color: white" name="time" />
										
										<input  type="hidden"  id="shedule_id" name="sheduleId" value="<?= $sheduleId ?>"></intpu>
