                            ...
                            <form class="signup-form">
                                ...
                                <div class="row" style="background-color: whitesmoke">
                                    ...
                                    <div class="col-xs-12 col-sm-6 col-md-12">
                                        <label style="float: left; font-size: 1.9em"><font color="#f98b68">Conditions </font> </label>
                                        <br/>
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-xs-12 col-sm-6 col-md-12">
                                       <label style="float: left">If you are having one of the following conditions, Then you are in the right place </label>
                                ...
                                <center>
                                    <div style="background-color:rgba(117,196,165,.6);">
                                          ...
                                          <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                <br />
                                                <label style="float: left">Bulimia</label>
                                        ...
                                        <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Insomnia</label>
                                         ...
                                         <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Bipolar Disorder</label>
  										 ...
  										 <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Depression</label>
                                        ...
                                        <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Panic Attacks</label>
                                        ...
                                        <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Substance Abuse</label>
                                        ...
                                        <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Stress</label>
                                        ...
                                        <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">OCD</label>
                                         ...
                                         <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">PTSD</label>
                                        ...
                                        <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Anxiety Disorder</label>
                                         ...
                                         <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Cognitive Disorder</label>
                                         ...
                                         <div class="row" style="margin:2px 0px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-12">
                                                ...
                                                <label style="float: left">Psychosis</label>
