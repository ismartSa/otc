...
$result = mysql_query("SELECT PatientID,Email, Password FROM patient WHERE Email = '$email'")or die ('Error updating database: '.mysql_error());;
$row = mysql_fetch_array($result);

if($row["Email"]==$email && $row["Password"]==$pass)
  {
   $_SESSION['newsession']=$row["PatientID"];
        ...
        <div class="container">
            <div id="home" class="header ">
                <div class="top-header">
                    <div class="logo">
                        <a href="Home.php"><a href="Home.php">OTC</a></a>
                    </div>
                    <!----start-top-nav---->
                    <nav class="top-nav">
                        <ul class="top-nav">
                            ...
                            <<li class="active-join" ><a href="login.php">DOCTOR LOG IN</a></li>
                        </ul>
                        <a href="#" id="pull">
               ...
               <?php unset($_SESSION['errMsg']); ?>
                        ...
                        <div class="form">
                            <form method="post" class="login-form" action="" >
                                <label style="float: left; font-size: 1.7em"><font color="#f98b68">  Patient Sign In</font></label>
                                ...
                                <br />
                                <br />
                                <p class="message">Not registered? <a href="PatientSignUp.html">Create a Patient account</a></p>
                            </form>
                        </div>
                    </div>
